...
**Reads with:** [`how-mavor-works.md`](./how-mavor-works.md) (internal daemon architecture), [`local-engine-benchmarks-and-architecture.md`](./local-engine-benchmarks-and-architecture.md) (multi-engine runtime matrix), [`../research/wayland-dictation-stack.md`](../research/wayland-dictation-stack.md) (Wayland desktop plumbing), [`../research/open-weight-models-and-runtimes.md`](../research/open-weight-models-and-runtimes.md) (open-weight models and runtimes), [`../roadmap.md`](../roadmap.md) (active roadmap).
